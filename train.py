...
if __name__ == '__main__':
    ...
    parser.add_argument('--find_table', action='store_true',
            help='If set, only function as judging the table correctness.')
